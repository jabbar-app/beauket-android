...
data class favoriteDTO(
    ...
    data class Data(
        ...
        val reviewWordCount: Any,
        val reviewWordCountMap: Any,
        ...
        data class Merchant(
            ...
            val mailOrderReportFileUrl: Any,
            ...
            val adminUserPassword: Any,
            val representativeEmailUsername: Any,
            val representativeEmailDomain: Any,
            val saleEmailUsername: Any,
            val saleEmailDomain: Any,
            val balanceEmailUsername: Any,
            val balanceEmailDomain: Any,
            val onlineShopTypeList: List<Any>
        )
